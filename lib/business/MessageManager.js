...
var MessageManager = function() {
  var createNewMessage = function createNewMessage(options) {
    return new Promise(function(resolve, reject) {
      ...
      createOptions.moreAction = options.moreAction;
      createOptions.moreLabel = options.moreLabel;
      ...
      model.setMoreAction(createOptions.moreAction);
      model.setMoreLabel(createOptions.moreLabel);
  ...
  var countMessages = function(filters) {
    return new Promise(function(resolve, reject) {
      Factory.getRepository('DFNotify/Message').countMessages(filters).then(
          function(count) {
            resolve(count);
          }
      ).catch(
